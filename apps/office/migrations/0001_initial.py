    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Banner Image')),
                ('description', ckeditor.fields.RichTextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('happy_travellers', models.CharField(blank=True, max_length=255, null=True)),
                ('satisfied_tours', models.CharField(blank=True, max_length=255, null=True)),
                ('total_destination', models.CharField(blank=True, max_length=255, null=True)),
                ('choose_info', models.ManyToManyField(blank=True, null=True, to='office.ChooseUs', verbose_name='Choose Info(Add only three infos)')),
            ],
            options={
