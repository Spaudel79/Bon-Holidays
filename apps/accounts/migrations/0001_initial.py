# Generated by Django 3.0.8 on 2021-01-15 06:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_type', models.CharField(choices=[('b', 'Bon-Admin'), ('g', 'Agent'), ('c', 'Customer')], default='g', max_length=1)),
                ...
                ('commission', models.CharField(default='15%', max_length=50)),
                ...
                ('travel_advice', ckeditor.fields.RichTextField()),
