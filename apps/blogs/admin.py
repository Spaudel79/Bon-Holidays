...
class TagAdmin(admin.ModelAdmin):
    ...
    def edit(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/tag/{}/change/">Change</a>', obj.id
        )

    def delete(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/tag/{}/delete/">Delete</a>', obj.id
        )
...
class BlogPostAdmin(ModelAdmin):
    ...
    def edit(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/blogpost/{}/change/">Change</a>',
            obj.id,
        )

    def delete(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/blogpost/{}/delete/">Delete</a>',
            obj.id,
        )
...
class CommentAdmin(ModelAdmin):
    def edit(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/comment/{}/change/">Change</a>',
            obj.id,
        )

    def delete(self, obj):
        return format_html(
            '<a class="btn-btn" href="/admin/blogs/comment/{}/delete/">Delete</a>',
            obj.id,
        )
